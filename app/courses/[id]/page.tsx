...
import { FileText, Video, Download, MessageSquare, Award } from "lucide-react"
...
export default function CoursePage({ params }: { params: { id: string } }) {
  ...
  const course = {
    ...
    quizzes: [
      { id: 1, title: "Week 1 Quiz", questions: 10, completed: true },
      { id: 2, title: "Week 2 Quiz", questions: 15, completed: true },
      { id: 3, title: "Week 3 Quiz", questions: 12, completed: false },
      { id: 4, title: "Midterm Exam", questions: 30, completed: false },
    ],
  }
